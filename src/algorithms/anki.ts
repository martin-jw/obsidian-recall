                ...
                text
                    ...
                    .onChange((newValue) => {
                        ...
                        if (isNaN(ease) || ease < 0) {
                            new Notice(
                                "Starting ease must be a positive number."
                            );
                            return;
                        }
                        ...
                        if (ease < 1.3) {
                            new Notice(
                                "Starting ease lower than 1.3 is not recommended."
                            );
                        }
                ...
                text
                    ...
                    .onChange((newValue) => {
                        ...
                        if (isNaN(bonus) || bonus < 1) {
                            new Notice(
                                "Easy bonus must be a number greater than or equal to 1."
                            );
                            return;
                        }
                ...
                text
                    ...
                    .onChange((newValue) => {
                        ...
                        if (isNaN(lapse) || lapse <= 0) {
                            new Notice(
                                "Lapse interval must be a positive number."
                            );
                            return;
                        }
